        ...
        child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              if (index % (nmOfGames + 1) == 0) {
                return NameTile(name: results[bowlerIndex].firstName + ' ' + results[bowlerIndex].lastName);
              }
              ...
              return InputScoreTile(bowlerInfo: results[bowlerIndex], gameNum: gameIndex, brain: scoreBrain, squad: selectedSquad,);
            }),
      ),
    );
  }
