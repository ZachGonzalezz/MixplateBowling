...
class DoublePartners {
  ...
  String isNoError(String squad){
    ...
    else if(bowlers[0].divisions[squad+ 'Doubles'] != bowlers[1].divisions[squad+ 'Doubles']){
      return bowlers[0].firstName + ' has a divsion of ' + (bowlers[0].divisions[squad + 'Doubles'] ?? 'None Set') + ' while ' + bowlers[1].firstName +  ' has a division of ' + (bowlers[1].divisions[squad + 'Doubles'] ?? 'None Set');
    }
    return '';
  }
