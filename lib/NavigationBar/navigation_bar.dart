        ...
        child: Padding(
          ...
          child: Column(children: [
            NavigationRow(
              ...
              screeName: 'Tournaments',
              sendTo: Constants.tournamentHome,
              isSelected: false,
            ),
            NavigationRow(
              icon: Icons.settings,
              screeName: 'Settings',
              sendTo: Constants.settingsHome,
            ...
            NavigationRow(
              icon: Icons.add,
              screeName: 'Create Bowler',
              sendTo: Constants.createNewBowler,
              isSelected: 'Create Bowler' == selected,
            ),
            NavigationRow(
              icon: Icons.person,
              screeName: 'Singles',
              sendTo: Constants.searchSingles,
              isSelected: 'Singles' == selected,
            ),
            NavigationRow(
              icon: Icons.groups_rounded,
              screeName: 'Doubles',
              sendTo: Constants.searchDoubles,
              isSelected: 'Doubles' == selected,
            ),
            NavigationRow(
              icon: MdiIcons.accountGroup,
              screeName: 'Teams',
              sendTo: Constants.teamSearch,
              isSelected: 'Teams' == selected,
            ),
            NavigationRow(
              icon: MdiIcons.bowling,
              screeName: 'Bowlers',
              sendTo: Constants.searchBowlers,
              isSelected: 'Bowlers' == selected,
            ),
            NavigationRow(
              icon: MdiIcons.scoreboard,
              screeName: 'Scores',
              sendTo: Constants.inputScores,
              isSelected: 'Scores' == selected,
            ),
            NavigationRow(
              icon: Icons.attach_money_rounded,
              screeName: 'Finances',
              sendTo: Constants.financeScreen,
              isSelected: 'Finances' == selected,
            ),
            NavigationRow(
              icon: Icons.comment,
              screeName: 'Brackets',
              sendTo: Constants.brackets,
              isSelected: 'Brackets' == selected,
            ),
