...
class SharePopUp extends StatefulWidget {
  SharePopUp(
      {Key? key,
      required this.emailsToSendTo,
      this.isTournamnetCreatedAlready = false,
      this.name = '',
      this.to,
      this.from,
      this.id = ''})
      ...
      content: Column(
        ...
        children: [
          TextField(
            ...
            onSubmitted: (text) {
              setState(() {
                widget.emailsToSendTo.add(text.toLowerCase());
            ...
            child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Column(
                    children: [
                      ShareWithTile(
                        email: widget.emailsToSendTo[index],
                        removeEmail: () {
                          setState(() {
          ...
          CustomButton(
              ...
              onClicked: () {
                ...
                if (widget.isTournamnetCreatedAlready) {
                  SettingsBrain().shareWithBowlers(
                      widget.emailsToSendTo,
                      widget.name,
